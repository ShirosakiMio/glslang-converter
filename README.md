# How to compile?
cmake -DCMAKE_CXX_COMPILER=/home/mio/env/gcc/bin/aarch64-linux-android-g++ -DBUILD_SHARED_LIBS=ON -DCMAKE_LIBRARY_PATH=/home/mio/env/gcc/sysroot/usr/lib -DCMAKE_INSTALL_PREFIX=$PWD/build -DBUILD_LIB_SOVERSION=OFF -DANDROID_ABI=arm64-v8a -DCMAKE_BUILD_TYPE=Release -DANDROID_STL=c++_static -DANDROID_PLATFORM=android-21 -DCMAKE_SYSTEM_NAME=Android -DANDROID_TOOLCHAIN=g++ -DANDROID_ARM_MODE=arm
# News
